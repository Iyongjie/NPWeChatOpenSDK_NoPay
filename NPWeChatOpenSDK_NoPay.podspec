#
# Be sure to run `pod lib lint NPWeChatOpenSDK_NoPay.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NPWeChatOpenSDK_NoPay.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'NPWeChatOpenSDK_NoPay/Classes/**/*'
  
  # s.resource_bundles = {
  #   'NPWeChatOpenSDK_NoPay' => ['NPWeChatOpenSDK_NoPay/Assets/*.png']
  # }
